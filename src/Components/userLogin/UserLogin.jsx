...
//       // 1. Check with backend if phone exists using encrypted API
...
//               type="submit"
//               disabled={loading}
//               className="w-full bg-yellow-400 text-[#0234c2] font-bold py-2 rounded-full hover:bg-yellow-300 transition disabled:opacity-50 disabled:cursor-not-allowed"
//             >
...
//           {/* Google Sign In */}
//           <button 
//             className="w-full border border-white py-2 rounded-full flex items-center justify-center gap-2 hover:bg-white hover:text-[#0234c2] transition"
//             disabled={loading}
//           >
//             <FaGoogle className="text-lg" />
//             Sign up with Google
...
//             src={girlImage}
//             alt="Representative"
//             className="absolute right-0 bottom-0 max-w-xs z-0"
//           />
//         </div>
//       </div>
//     </div>
