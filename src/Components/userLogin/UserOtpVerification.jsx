...
// import { authAPI, secureApiClient } from "../../Clients-components/PropertyController"; // Updated import
...
//       // 3. Verify with backend using encrypted API
...
//       // 4. Store encrypted token and user data
//       if (response.data.token) {
//         secureApiClient.storeEncryptedToken(response.data.token);
//       }
...
//       const storedData = sessionStorage.getItem('otpVerificationData');
//       if (!storedData) {
...
//       // Resend OTP using encrypted API
...
//       if (lastFilledIndex >= 0 && inputs.current[lastFilledIndex]) {
...
//       {/* Card */}
//       <div className="relative z-10 bg-[#0140BA] rounded-xl p-8 md:p-12 w-full max-w-3xl flex flex-col md:flex-row justify-between items-center text-white">
...
//             Enter 6 digit OTP sent to <span className="font-semibold text-white">{phoneNumber || "+91 9999999999"}</span>
//           </p>
...
//                   className="w-12 h-12 text-center text-lg font-semibold border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-yellow-400 text-black"
//                   disabled={loading}
//                 />
//               ))}
//             </div>
...
//               className="w-full bg-yellow-400 text-[#0234c2] font-bold py-3 rounded-full hover:bg-yellow-300 transition disabled:opacity-50 disabled:cursor-not-allowed"
//             >
...
//                 disabled={loading}
//                 className="text-yellow-300 hover:text-yellow-200 underline disabled:opacity-50"
//               >
//                 Resend OTP
//               </button>
//             ) : (
//               <p className="text-gray-300">
//                 Resend OTP in <span className="text-yellow-300">{timer}s</span>
//               </p>
//             )}
//           </div>
...
//             src={woman} 
//             alt="Verification" 
//             className="w-64 lg:w-80 max-w-full" 
//           />
//         </div>
//       </div>
//     </div>
