...
//                     securityDeposit: bookingData.depositAmount,
...
//                     alert(`The following rooms are not available: ${errorData.unavailableRooms.join(', ')}. Please go back and select different rooms.`);
//                     return;
//                 }
...
export default function AddProof() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Prepare booking data with duration information
            const bookingRequest = {
                propertyId: bookingData.propertyId,
                roomType: bookingData.selectedRoomType,
                selectedRooms: bookingData.selectedRooms,
                moveInDate: bookingData.selectedDate,
                endDate: bookingData.endDate, // Add endDate
                durationType: bookingData.durationType, // Add durationType
                durationDays: bookingData.durationDays, // Add durationDays
                durationMonths: bookingData.durationMonths, // Add durationMonths
                personCount: bookingData.personCount || personCount,
                customerDetails: {
                    primary: {
                        name: customers[0]?.name || "",
                        ...
                        {bookingData && (
                            <div className="bg-blue-50 p-4 rounded-lg mb-4">
                                ...
                                <div className="text-sm">
                                    <p><strong>Duration:</strong> {bookingData.durationType === "monthly" 
                                        ? `${bookingData.durationMonths} month(s)` 
                                        : bookingData.durationType === "daily" 
                                            ? `${bookingData.durationDays} day(s)`
                                            : `${bookingData.selectedDate} to ${bookingData.endDate}`}
                                    </p>
                                    <p><strong>Check-in:</strong> {bookingData.selectedDate}</p>
