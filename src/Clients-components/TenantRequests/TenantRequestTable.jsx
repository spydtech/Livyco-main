                ...
                {filteredTenants.length > 0 ? (
                  filteredTenants.map((tenant, index) => (
                    ...
                    >
                      ...
                      <td className="p-3">
                        {tenant.bookingDetails?.moveInDate
                          ? new Date(tenant.bookingDetails.moveInDate).toLocaleDateString()
                          : "N/A"}
                      </td>
                      <td className="p-3">
                        <span
                        ...
                        >
                          {tenant.bookingDetails?.paymentStatus}
                        </span>
                      </td>
                      <td className="p-3">
                      ...
                      <td className="p-3">
                        {tenant.bookingDetails?.roomType || "N/A"}
                      </td>
                      <td
                        className="p-3 text-blue-600 cursor-pointer"
                        onClick={() =>
